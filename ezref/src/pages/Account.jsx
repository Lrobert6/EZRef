        ...
        <div>
            ...
            <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '3rem', padding: '3rem 5rem'}}>
                <Card title={'Profile'} style={{position: 'relative', width: '50%'}}>
                    ...
                    <table >
                        <tr>
                            <td>First Name<input type='text' readOnly={profileReadOnly}/></td>
                            <td>Last Name<input type='text' readOnly={profileReadOnly}/></td>
                        </tr>
                        <tr>
                            <td>Date of Birth<input type='date' readOnly={profileReadOnly}/></td>
                            <td>Email Address<input type='text' readOnly={profileReadOnly}/></td>
                        </tr>
                        
                        <tr>
                            <td>City<input type='text' readOnly={profileReadOnly}/></td>
                            <td>State<input type='text' readOnly={profileReadOnly}/></td>
                        </tr>
                        <tr>
                            <td>Country<input type='text' readOnly={profileReadOnly}/></td>
                            <td>Postal Code<input type='text' readOnly={profileReadOnly}/></td>
                        </tr>
                    </table>
                </Card>
                <Card title={'Settings'} style={{position: 'relative', width: '50%'}}>
                    ...
                    <table>
                        <tr>
                            <td>Public<input type='text' readOnly={settingsReadOnly}/></td>
                            <td>Theme<input type='text' readOnly={settingsReadOnly}/></td>
                        </tr>
                    </table>
                </Card>
            </div>
